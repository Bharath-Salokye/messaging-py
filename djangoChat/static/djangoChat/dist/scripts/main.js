...
define('text!templates/message.tmpl',[],function () { return '<div class="signature" >\n\t<div class="avatar">\n\t\t<img title="<%=user%>" alt="<%=user%>" src="<%=gravatar%>?d=identicon&amp;s=32" height="32" width="32">\n\t</div>\n\t<div class="username"><%=user%></div>\n\t<p class="clear-both"></p>\n</div>\n<div class="messages">\n\t<div class="msg">\n\t\t<%=msg%>\n\t\t<span><%=time%></span>\n\t</div>\n</div>\n<p class="clear-both"></p>';});

define('views/message',['backbone','underscore','text!templates/message.tmpl'],function(Backbone,_,MessageTmpl){
...
define('channel',['backbone'], function (Backbone) {
    var channel = _.extend({}, Backbone.Events);
    return channel;
});
define('views/messages',['backbone','views/message','channel'],function(Backbone,MsgView,Channel){
...
define('views/addMessage',['backbone','channel'],function(Backbone,Channel){
...
define('models/message',['backbone','jquery'],function(Backbone,$){
...
define('collections/messages',['backbone','models/message'],function(Backbone,MsgModel){
...
define('text!templates/user.tmpl',[],function () { return '<div class="s_avatar">\n\t<img src="<%= gravatar %>" width="40px" height="40px" style ="vertical-align:middle"/>\n</div>\n<div class="s_username">\n\t<a href="#"><%= username %></a>\n</div>\n<p class="clear-both"></p>\n\n\n';});

define('views/user',['backbone','underscore','text!templates/user.tmpl'],function(Backbone,_,usrTmpl){
	return Backbone.View.extend({
		tagName : 'div',
		className : 's_user',
...
define('views/users',['backbone','views/user'],function(Backbone,usrView){
...
define('collections/users',['backbone','models/user'],function(Backbone,usrModel){
